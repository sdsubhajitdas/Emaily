                        ...
                        <div
                          ...
                          <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0"
                            ...
                            <tbody>
                              <tr>
                                <td
                                  style="overflow-wrap:break-word;word-break:break-word;padding:150px 10px 10px;font-family:arial,helvetica,sans-serif;"
                                  align="left">
                              ...
                              <tr>
                                <td
                                  ...
                                  <div style="font-size: 18px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                    <p style="line-height: 140%;"><em>Please answer the following question: </em></p>
                                  </div>
                              ...
                              <tr>
                                <td
                                  ...
                                  <div
                                    ...
                                    <p style="line-height: 140%;">${survey.body}</p>
                                  </div>
                                  ...
                                  <div align="center">
                                    ...
                                    <a href="${process.env.EMAIL_REDIRECT_DOMAIN}/api/survey/${survey.id}/yes" target="_blank"
                                      ...
                                      <span style="display:block;padding:10px 20px;line-height:120%;"><span
                                          style="line-height: 21.6px;">Yes</span></span>
                                    </a>
                                ...
                                <td
                                  ...
                                  <div align="center">
                                    ...
                                    <a href="${process.env.EMAIL_REDIRECT_DOMAIN}/api/survey/${survey.id}/no" target="_blank"
                                      ...
                                      <span style="display:block;padding:10px 20px;line-height:120%;"><span
                                          style="line-height: 21.6px;">No</span></span>
                                    </a>
                                    <!--[if mso]></center></v:roundrect><![endif]-->
                                  </div>
